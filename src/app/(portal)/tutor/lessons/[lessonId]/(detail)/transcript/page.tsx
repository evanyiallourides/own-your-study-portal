...
export default async function TutorLessonTranscript({
  params,
}: {
  ...
  if (!transcript || transcript.processingStatus !== "ready" || transcript.segments.length === 0) {
    return (
      <EmptyState
        ...
        description="A transcript exists only when the AI Notetaker joined the meeting and consent was recorded for the student."
      />
    );
  }
